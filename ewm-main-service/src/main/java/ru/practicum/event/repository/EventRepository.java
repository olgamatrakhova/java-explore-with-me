...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    boolean getByIdAndInitiatorId(long eventId, long userId);
    ...
    List<Event> getAllEvents(String text, List<Long> categories, Boolean paid, LocalDateTime start,
                             LocalDateTime end, Boolean onlyAvailable, String sort, Pageable pageable);

    boolean getByCategoriesId(long catId);
}
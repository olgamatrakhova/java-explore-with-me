...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    Optional<Event> findAllEventsById(long eventId);
    ...
    List<Event> findAllEventsByParam(List<Long> users, List<EventStatus> states, List<Long> category,
    ...
    List<Event> findAllEvents(String text, List<Long> category, Boolean paid, LocalDateTime start,
